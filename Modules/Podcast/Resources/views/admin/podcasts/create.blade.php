...
@section('content-header')
    <h1>
        {{ trans('podcast::podcasts.title.create podcast') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.podcast.podcast.index') }}">{{ trans('podcast::podcasts.title.podcasts') }}</a></li>
        <li class="active">{{ trans('podcast::podcasts.title.create podcast') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.podcast.podcast.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('podcast::admin.podcasts.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
